<div>
    ...
    {!!  Form::open(['route' => ['attributes.edit', $attribute->id], 'method' => 'get', 'class' => 'form-data-edit']) !!}
    {!! Form::close() !!}

    {!!  Form::open(['route' => ['attributes.destroy', $attribute->id], 'method' => 'delete', 'class' => 'form-data-remove']) !!}
    {!! Form::close() !!}
</div>
