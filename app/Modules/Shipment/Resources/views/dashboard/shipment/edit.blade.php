...
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title"><span class="fa fa-edit"></span> Create Shipment</h3>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        ...
        <div class="box-body">
                ...
                <div class="col-md-10">
                    @foreach(ViewDataHelper::getLanguages() as $language)
                        ...
                        <span class="input-group-addon"><span
                            ...
                            {{ Form::text("locales[{$language->code}][name]", $shipment->getLocaled('name', $language->code), ['class' => 'form-control', 'placeholder' => 'Value', 'required']) }}
                        </div>
                    @endforeach
                </div>
            </div>
            ...
            <div class="form-group @if($errors->has('name')) has-error @endif">
                ...
                <div class="col-md-10">
                    {{ Form::select('status', ViewDataHelper::getShipmentStatuses(), null, ['class' => 'form-control']) }}
                </div>
            </div>
