<div>
    ...
    {!!  Form::open(['route' => ['shipments.edit', $shipment->id], 'method' => 'get', 'class' => 'form-data-edit']) !!}
    {!! Form::close() !!}

    {!!  Form::open(['route' => ['shipments.destroy', $shipment->id], 'method' => 'delete', 'class' => 'form-data-remove']) !!}
    {!! Form::close() !!}
</div>
