...
@section('content')
    <div class="box box-primary">
        ...
        {!! Form::model($group, ['route' => ['customer-groups.update', $group->id], 'method' => 'post', 'class'=> 'form-horizontal']) !!}
        <div class="box-body">
                ...
                <div class="col-md-10">
                    ...
                    @foreach(ViewDataHelper::getLanguages() as $language)
                        ...
                        <span class="input-group-addon"><span
                            ...
                            {{ Form::text("locales[{$language->code}][name]", $group->getLocaled('name', $language->code), ['class' => 'form-control', 'placeholder' => 'Value', 'required']) }}
                        </div>
                ...
                <div class="col-md-10">
                    <label>
                        <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
                            {{ Form::checkbox('is_should_approve', 1, null, ['hidden']) }}
