<div>
    ...
    {!!  Form::open(['route' => ['languages.edit', $language->code], 'method' => 'get', 'class' => 'form-data-edit']) !!}
    {!! Form::close() !!}

    {!!  Form::open(['route' => ['languages.destroy', $language->code], 'method' => 'delete', 'class' => 'form-data-remove']) !!}
    {!! Form::close() !!}
</div>
