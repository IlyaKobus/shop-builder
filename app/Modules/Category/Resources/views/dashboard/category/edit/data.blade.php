<div class="tad-data">
    <div class="form-group @if($errors->has('parent_id')) has-error @endif">
        ...
        <div class="col-md-10">
            {{ Form::select('parent_id', ViewDataHelper::getCategoriesSelect(), $category->parent_id, ['class' => 'form-control', $category->parent_id ? '': 'disabled']) }}
        ...
        <div class="col-md-offset-2 col-md-10">
            <label>
                <div class="icheckbox_square-blue" aria-checked="false" aria-disabled="false">
                    {{ Form::checkbox('is_root', 1, !$category->parent_id, ['hidden']) }}
    ...
    <div class="form-group @if($errors->has('sort_order')) has-error @endif">
        ...
        <div class="col-md-10">
            {{ Form::number("sort_order", $category->sort_order, ['class' => 'form-control', 'placeholder' => 'Sort Order']) }}
    ...
    <div class="form-group @if($errors->has('status')) has-error @endif">
        ...
        <div class="col-md-10">
            {{ Form::select('status', ViewDataHelper::getCategoryStatuses(), $category->status, ['class' => 'form-control']) }}
