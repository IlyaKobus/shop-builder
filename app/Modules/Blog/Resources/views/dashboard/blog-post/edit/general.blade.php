        ...
        @foreach(ViewDataHelper::getLanguages() as $language)
            <div class="tab-pane @if($loop->first) active @endif"
                ...
                <div class="form-group required @if($errors->has("locales[{$language->code}][title]")) has-error @endif">
                    ...
                    <div class="col-md-10">
                        {{ Form::text("locales[{$language->code}][title]", $post->getLocaled('title', $language->code), ['class' => 'form-control', 'placeholder' => 'Name', 'required']) }}
                ...
                <div class="form-group @if($errors->has("locales[{$language->code}][description]")) has-error @endif">
                    ...
                    <div class="col-md-10">
                        {{ Form::textarea("locales[{$language->code}][description]", $post->getLocaled('description', $language->code)) }}
                ...
                <div class="form-group @if($errors->has('meta_tag_title')) has-error @endif">
                    ...
                    <div class="col-md-10">
                        {{ Form::text("locales[{$language->code}][slug]", $post->getLocaled('slug', $language->code), ['class' => 'form-control', 'placeholder' => 'Slug', 'readonly']) }}
                ...
                <div class="form-group required @if($errors->has("locales[{$language->code}][meta_tag_title]")) has-error @endif">
                    ...
                    <div class="col-md-10">
                        {{ Form::text("locales[{$language->code}][meta_tag_title]", $post->getLocaled('meta_tag_title', $language->code), ['class' => 'form-control', 'placeholder' => 'Meta Tag Title', 'required']) }}
                ...
                <div class="form-group @if($errors->has("locales[{$language->code}][meta_tag_description]")) has-error @endif">
                    ...
                    <div class="col-md-10">
                        {{ Form::text("locales[{$language->code}][meta_tag_description]", $post->getLocaled('meta_tag_description', $language->code), ['class' => 'form-control', 'placeholder' => 'Meta Tag Description']) }}
                ...
                <div class="form-group @if($errors->has("locales[{$language->code}][meta_tag_keywords]")) has-error @endif">
                    ...
                    <div class="col-md-10">
                        {{ Form::text("locales[{$language->code}][meta_tag_keywords]", $post->getLocaled('meta_tag_keywords', $language->code), ['class' => 'form-control', 'placeholder' => 'Meta Tag Keywords']) }}
